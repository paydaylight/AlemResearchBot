...
def get_categories():
    lst = [['Все проблемы', 'Безопасность',
            ...
            'ЖКХ', 'Здравоохранение',
            'Инфраструктура', 'Коррупция', 'Трудовые отношения',
            'Судебно-правовая система', 'Межэтнические и религиозные отношения',
            'Образование', 'Общественный транспорт',
            'Транспорт и автомобильные дороги', 'Экология', 'Другое']]
    return lst


def get_locations():
    lst = [['Республика Казахстан', 'г. Астана',
            'г. Алматы', 'г. Шымкент', 'Акмолинская область',
            ...
            'Мангистауская область', 'Южно-Казахстанская область', 'Павлодарская область',
